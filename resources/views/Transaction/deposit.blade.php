            ...
            <div class="card card-body mt-4">
                <div class="row align-items-center">
                    <div class="col-12 col-md-6 text-center mb-4 mb-md-0">
                        <div>
                            <h1>Deposit</h1>
                            <p>Selamat datang di halaman deposit kami! Isi form di bawah ini untuk menambahkan dana ke akun
                                Anda dengan cepat dan aman. Pastikan Anda memasukkan jumlah yang tepat dan PIN untuk
                                melanjutkan.</p>
                        </div>
